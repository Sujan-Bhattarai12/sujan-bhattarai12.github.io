---
title: "Comparison of competing classificaiont Machine Learning Models in songs classification"
format:
  html:
    toc: true
...
categories: [ML] # self-defined categories
...
The data is downloaded from <https://www.kaggle.com/datasets/mrmorj/dataset-of-songs-in-spotify>. Do some aspects of data cleaning, selecting only fewer columns and rows based on interest.
...
### Data Exploration 
Just for an overview, look at the first few rows of the dataset and also the summary of the dataset. The output table is formated based on kable package, which is pretty popular in R.
