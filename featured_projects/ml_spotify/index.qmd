---
title: "Comparing competing ML models in classifying songs"
format:
  html:
    toc: true
...
The data is downloaded from <https://www.kaggle.com/datasets/mrmorj/dataset-of-songs-in-spotify>. Do some of data cleaning, selecting only fewer columns and rows based on interest.
