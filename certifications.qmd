...
<div style="display: flex; align-items: center; justify-content: space-between; margin-top: 20px;">
  <div style="flex: 1;">
    ...
    <div style="background-color: #213343; font-size: 16px; border: 1px solid darkgrey; padding: 10px; margin-top: 10px; border-radius: 10px;">
...
<div style="display: flex; align-items: center; justify-content: space-between; margin-top: 20px;">
  <div style="flex: 1;">
    ...
    <div style="background-color: #213343; font-size: 16px; border: 1px darkgrey white; padding: 10px; margin-top: 10px; border-radius: 10px;">
      <ul style="list-style-type: none; padding: 0; margin: 0;">
