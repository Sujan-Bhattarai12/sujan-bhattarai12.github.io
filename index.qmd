  ...
  <div class="areas-of-interest">
    ...
    <div class="colu">
      ...
      <div class="colus">
        ...
        <p>Strong understanding of underlying maths in ML models, Linear algebra, and calculus.</p>
      </div>
      <div class="colus">
        <h3>Geospatial analysis</h3>
        <p>Knowledge about spatial data to make space based data driven decision making</p>
      </div>
      <div class="colus">
        <h3>Database and Cloud</h3>
        <p>Self-taught in Big Data and certified in Snowflake for data warehousing, proficient at RDBMS and SQL</p>
      </div>
      <div class="colus">
